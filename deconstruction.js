...
const recommendations = {
 ...
 const  {beer, coffee}=recommendations;
    console.log(`Places you can have drinks are: ${beer} and ${coffee}`);  

 
 const {music: {jazz}} = recommendations;
     console.log(`Here are some of the places you can listen to jazz music: ${jazz}`);

//function that takes the object as an argument
function placesToVisit ({music: {jazz, traditional}}) {
    console.log(`Here are some of the places you can listen to music: ${jazz}, ${traditional}`);
}
placesToVisit(recommendations);
